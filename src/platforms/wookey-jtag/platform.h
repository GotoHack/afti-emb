...
#define TRST_PORT	GPIOB // UNUSED
#define TRST_PIN	GPIO1 // UNUSED
#define PWR_BR_PORT	GPIOB // UNUSED
#define PWR_BR_PIN	GPIO1 // UNUSED
#define SRST_PORT	GPIOA
#define SRST_PIN	GPIO2
#define SRST_SENSE_PORT	GPIOA // UNUSED
#define SRST_SENSE_PIN	GPIO7 // UNUSED

#define USB_PU_PORT	GPIOA // UNUSED
#define USB_PU_PIN	GPIO8 // UNUSED

#define USB_VBUS_PORT	GPIOB // UNUSED
#define USB_VBUS_PIN	GPIO13 // UNUSED
#define USB_VBUS_IRQ	NVIC_EXTI15_10_IRQ // UNUSED

#define LED_PORT	GPIOB
#define LED_PORT_UART	GPIOB
#define LED_0		GPIO2 // UNUSED
#define LED_1		GPIO10
#define LED_2		GPIO11// UNUSED
#define LED_UART	LED_0 // UNUSED
#define LED_IDLE_RUN	LED_1
#define LED_ERROR	LED_2 // UNUSED
